...
python shoreline.py "$W" ../buildmap/plan_v8/shoreline2_v8.json $C/v8_cell_pass6_inspect.npz 2>&1 | tail -4
python regrade.py "$W" -1030 -2350 -790 -2060 --was-land $C/v8_cell_pass5_inspect.npz 2>&1 | tail -1
...
python lakefill.py "$W" ../buildmap/plan_v8/lakefill_canopy_v8.json 2>&1 | tail -2
