...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<Soldier>> NATO_SOLDIER = soldier("nato_soldier", Faction.NATO);
    public static final RegistryObject<EntityType<Soldier>> RUAF_SOLDIER = soldier("ruaf_soldier", Faction.RUAF);

    private ModEntities() {}

    private static RegistryObject<EntityType<Soldier>> soldier(String name, Faction faction) {
