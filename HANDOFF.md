...
- `docs/gscraft-quests.md` - all 136 quests, seven NPC chapters (Teddy the Hermit at the Woods outpost: explosives), what FTB Quests needs from KubeJS.
...
- `docs/notes/gscraft-pomkots-mechs.md` - Pomkot's Mechs research (2026-09-04): fits the hub (dormant units, two enemy types, the PMB01 "Custodian" guarding the phased array) and one dormant unit at FR-06, one late player mech; needs a local performance test and the owner's yes before it is added.
