...
| **Walls 2** | `superbwarfare:drone`: 1 circuit assembly + 1 motor assembly + 1 small battery pack; `swarm_drone` ×2: 1 circuit assembly + 4 metal scrap. **No Superb Warfare mortar** (2026-09-05): its artillery stays stripped; Create Big Cannons' **drop mortar** is Walls 2's piece (hand-loaded, redstone-fired — mod plan §10), and the map's artillery proper is the Create chapter's gun, built in the camp from G1 | Marshall, D2 |
