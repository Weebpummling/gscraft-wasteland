...
| **Kessler** | KROT | IE `machinist` | the foundry, cast iron | casting sand, cast iron, bronze |
...
|---|---|---|---|---|
| **home** — the Skadowsky sector: the camp pocket (perimeter x −978…−770 × z −1060…−845, world spawn the paved junction at −940, −979), the hospital, the station, the rail yard, the level crossing | the Dead, dense outside the pocket: Shamblers 6, Workers 2, Runners 2, the Matron's brood; nothing inside the camp outline — which is the **south compound** at the start (2026-09-12, the compound start) (`camp_compound`), and grows a box at a time as the players take the square, the gatehouse, the north complex and the crossing (`camp_*` zones by stage, `tools/war_zones.py`); two Magnum Torches at the start, four by stage; the pocket whole, and suppression over the sector, on `skadowsky_held` | **the hospital:** the Dead (the Matron) | the Knocker in the hospital at night; the Eyes at night beyond the torches | none |
...
switchyard, turbine hall and cooling intake works, and KROT. The wave composition, elite and
