...
hempcrete compound; eight places named throughout the rows below are **deferred to a later quest line** and no quest
...
| C6 | Coordinates for glass tower, acacia hall, library, hempcrete compound, stone complex, residential block rectangle; copper tower / prismarine hall roles *(2026-09-07: the library is deferred to a later quest line, the stone complex is gone from the v8 map, the hempcrete compound is x −3392…−3073 × z −1344…−1025, and the "residential block" is the Skadowsky hospital at x −865…−698 × z −1312…−1242, roof y 115, ground y 64)* | B (layout sheet, from site_inventory) |
| C7 | Sites that drop nothing anyone needs (copper tower, prismarine hall, hempcrete compound, stone complex, mud village, the Woods) *(2026-09-07: the stone complex is gone from the v8 map)* | C (loot tables by site) |
