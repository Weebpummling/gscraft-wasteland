> **Archived 2026-09-13.** the v6 placement sheet; the world is v8. Nothing in this file is current; it is kept as the record. The living description of the game is `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
...
The library, KROT, stone complex, mud village, acacia hall, glass tower and the small
...
| KROT | 1568 1152 1887 1471 | 320×320 | 2.0 km | IE hempcrete, razor wire | medical and hardware; fallback transplant site |
