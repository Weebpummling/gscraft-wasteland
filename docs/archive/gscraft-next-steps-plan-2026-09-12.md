> **Archived 2026-09-13.** the plan of 2026-09-12; steps 1-3 built, the rest withdrawn by the reassessment (gscraft-system-2026-09-13.md §6). Nothing in this file is current; it is kept as the record. The living description of the game is `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
...
> **Withdrawn 2026-09-13 (owner).** Steps 1–3 were built and are reassessed in `gscraft-system-2026-09-13.md` §6 (step 2 to be cut down to a stage plus its functions); steps 4–5 (the walk-through, the live push) are withdrawn until the vertical slice of that document's §7 plays; step 6 is replaced by the slice. This file stays as the record of what was built and why.
