> **Archived 2026-09-13.** the first enemy document; superseded by gscraft-entities-v8.md, the enemy review and the mod's data (gscraft_ranks, gscraft_factions). Nothing in this file is current; it is kept as the record. The living description of the game is `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
