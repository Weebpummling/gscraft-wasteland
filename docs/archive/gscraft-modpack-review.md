> **Archived 2026-09-13.** the mod pack review of 2026-09-04; the pack has moved on (packwiz is the record). Nothing in this file is current; it is kept as the record. The living description of the game is `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
