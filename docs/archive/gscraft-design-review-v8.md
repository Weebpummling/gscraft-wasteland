> **Archived 2026-09-13.** the plateau-era review; its economy findings are carried in the gaps ledger. Nothing in this file is current; it is kept as the record. The living description of the game is `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.

# GSCraft Wasteland — design review on the final v8 sectors

> **Archived 2026-09-13.** Only §4's three economy findings survive — the card model starves, the caps flood, and three inputs have no source (cast iron, casting sand, IE steel) — and they are carried in `gscraft-design-gaps.md` under "Carried from design-review-v8 (2026-09-13)". Everything else here is superseded by the compound start and the `gscraft` mod.
...
| **FR-06** 2.2 km E | J-S4 / M8 / R5 / M9–M11 | transformer core ×9, reactor control ×5, avionics ×6 — three per 40 min | Rook: the steel works | Fits: the biggest build as NATO's base, the hangar, the mechs |
...
- **Emeralds in** (vendors §2, loot §3–6): loot weights 3–8 per roll, quest rewards 4–8, NATO drops, a trip's junk 10–20. **Out:** guns 15–80, ammunition 3–8, NVG 60, drones 30, rockets 12–20, cards 4, Recruits at the mod's price (camp spec §4 names no price). Coin is the limiter, as intended.
