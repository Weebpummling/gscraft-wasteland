> **Research record, filed 2026-09-13.** the road rework of v8 (tools roadpatch/roadrelay/roadmask); done in the world. What was built from it is described in `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
