> **Research record, filed 2026-09-13.** the 1.12 block conversion of the desert city (the hub, deferred). What was built from it is described in `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
