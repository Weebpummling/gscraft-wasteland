> **Research record, filed 2026-09-13.** built in part (A1/A2 animation clips). What was built from it is described in `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
