> **Research record, filed 2026-09-13.** why 10 km; the border ruling. What was built from it is described in `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
