> **Research record, filed 2026-09-13.** in-game tooling for the map designers. What was built from it is described in `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
