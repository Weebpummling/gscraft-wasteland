> **Research record, filed 2026-09-13.** the first enemy design pass; superseded by the enemy review of 2026-09-10 and the mod. What was built from it is described in `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
