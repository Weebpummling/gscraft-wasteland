> **Research record, filed 2026-09-13.** the Machines' mod; the faction exists, the set pieces are Act IV. What was built from it is described in `docs/gscraft-system-2026-09-13.md`; the index is `docs/README.md`.
