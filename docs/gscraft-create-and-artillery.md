...
> **Rehomed 2026-09-13.** The keepers stand per map-design §2.3: **Kessler at KROT, Ilya at the switchyard, Rook at the turbine hall, Oksana at the intake works, Vera at the hospital** — §3's table below names the dead sites and is struck row by row. The tier-3 rule is a confinement-hall item or a second held-site component (the hub rule is dropped); the gates read G1 `krot_looted`, G5 `hospital_held`, and G6/G7/G8 rehomed to the turbine hall, the switchyard and the turbine hall per the keeper table, marked [owner to confirm]; the gun pit is at the mast field's west edge, x −846…−835 × z −1000…−989, not on any plateau bluff.
...
|---|---|---|---|---|---|
| ~~**Novo Expograd Industrial Zone**~~ **KROT** (heavy industry (2026-09-13, reconciliation)) | **Kessler**, the foundryman | rubble cleared from the main hall, roof patched, the yard lit | the **foundry**: the mould bench (Create saw), three basins on blaze burners, casting-sand pit — cast iron and bronze pour here four barrels at a time (the camp's yard pours one) | walled yard, two site-guard posts, a **crane** over the cast pit (rope pulley) | bulk cast iron and bronze for the steel gun (4.6) |
| ~~**Industrial plant**~~ **the plant's cooling intake works** (fuel and water (2026-09-13, reconciliation)) | **Oksana**, the plant chief | pump house cleared, one boiler relit | the **power house**: steam engine on the rebuilt boilers, the shaft run to the **boring mill** (cannon drill + drill bit) | fence, a guard tower, the water intake fortified | fast boring: the steel barrels of G6 (the camp's hand-cranked frame bores cast iron only) |
| ~~**FR-06 complex**~~ **the plant's turbine hall** (power (2026-09-13, reconciliation)) | **Rook**, the millwright | reactor hall floor cleared, the hangar door freed (a Create sliding door) | the **steel works**: the cannon builder (built-up layers), the mechanical press line for cartridges, the hangar as the gun shed | blast wall, autocannon nest on the roof | steel guns (4.4), big cartridges |
| ~~**Financial Plaza Quarantine**~~ **the plant's switchyard and admin block** (electronics (2026-09-13, reconciliation)) | **Ilya**, the clerk | ground floor cleared, the lifts (rope pulleys) running | the **fuze lab**: mechanical crafters for shells, the fuze bench (the mod's four: impact, timed, inertia, proximity) | shutters, a guard post in the lobby, the sewers sealed behind a bar | shells and fuzes (4.5) |
| **The Skadowsky hospital** (medical; x −865…−698 × z −1312…−1242, 0.34 km north of the camp square. Realigned 2026-09-07: the sector itself is home, and the hospital inside it is the strongpoint) | **Vera**, the nurse | the hospital's school wing cleared as the field hospital; the level crossing freed | the **hospital**: a second revive point (the script's camp-revive rule applied to the hospital rectangle) and the cure, free, as at Tony's | the **rail yard**: the train's depot, the schedule block, the fuel bunker; the highway viaduct's checkpoint | the **gunner's manual** (tier 1, a book item: the range card of G5); the train (tier 3; section 2, James) |
...
bulk material (concrete, steel frames) plus one more of the site's own loot-only component; ~~tier 3 = one hub item.~~ tier 3 = a confinement-hall item or a second held-site component; the hub rule is dropped with the hub (2026-09-13, reconciliation). The
...
camp** (owner, 2026-09-05): G1–G4 happen at Walker's yard (x −975…−940 × z −880…−845) and the gun pit on the
mast field's west edge (x −846…−835 × z −1000…−989), with materials looted from the town around the camp — Novo is
deferred to a later quest line — so the team fires a gun before it holds a single site; the strongpoints then scale it up (steel, boring, shells,
...
|---|---|---|---|---|---|---|
| G1 | Sand and iron | II | **camp — Walker's yard** | W-B2 (the basin and blaze burner), ~~`novo_looted`~~ `krot_looted` (2026-09-13, reconciliation) | hand in 16 casting sand (2 sand + dirt + clay each), 8 cast-iron ingots (Novo's loot table, loot §4 — or the yard's basin melts 2 iron ingots + 1 coal per ingot with the mod's own recipe; later Kessler's counter), 4 logs | the **cannon cast** and the moulds (`small_cast_mould`, `cannon_end_cast_mould` — the yard's Create saw cuts them from logs); the yard's basins pour molten cast iron (Walker tier 2 gains the basin, blaze burner, saw, cast pit and boring frame — design §3.6) |
...
| G5 | The gunner's manual | III | Skadowsky | ~~S-residential-1~~ `hospital_held` (2026-09-13, reconciliation), G4 | hand in the manual (Vera) and 2 spyglasses | the **range card**: a Patchouli book per gun, pitch and charges to range (the mod ships none); the pit's display board (a Create display link from the mount, Tune's U-B2) and the range rings on the map wall |
| G6 | Steel | III | ~~FR-06 T2 (the cast iron now pours at Novo's foundry, S-novo-2, four barrels a pour)~~ the turbine hall T2 — Rook's steel works; the cast iron pours at KROT's foundry (S-krot-2), the bore at the intake works' mill (S-intake-2) [owner to confirm] (2026-09-13, reconciliation) | ~~S-fr06-2, S-novo-2, G5, `fr06_defended`~~ S-turbine-2, S-krot-2, G5, `turbine_defended` [owner to confirm] (2026-09-13, reconciliation) | 24 steel ingots (IE steel, `forge:ingots/steel`) melted at Novo, poured as steel barrels; the **cannon builder** at FR-06 wraps built-up layers | the long gun: steel chamber + 5 barrels; the quick-firing breech |
| G7 | Shells | III–IV | ~~the plaza T2~~ the switchyard T2 — Ilya's fuze lab [owner to confirm] (2026-09-13, reconciliation) | ~~S-financial-2~~ S-switchyard-2 [owner to confirm], G6 | mechanical crafters: 4 HE shells, 2 AP shells, 2 shrapnel; fuzes: impact and proximity (the mod's own recipes; there is no "fuze head" item) | shells and fuzes as station orders; the smoke shell for the Woods |
| G8 | The battery | IV | ~~FR-06 T3~~ the turbine hall T3 [owner to confirm] (2026-09-13, reconciliation), the gatehouse T3 | ~~S-fr06-3~~ S-turbine-3 [owner to confirm], R-B3 | a bronze **autocannon** (breech extractor by sequenced assembly, recoil spring, 3 barrels; big cartridges pressed from brass sheets) on each watchtower, its breech wrenched for handles so a player aims it — the mod's Ponder "customizing autocannons": handles are a breech state, not an item, and a seat on it is cosmetic; an ammo container of AP rounds | Walls 3 = the autocannon nests (they replace the laser tower); the crater's last line has guns on it |
...
| G10 | Nethersteel (optional) | IV | the tower | tower stage 4 | nethersteel (steel + nether material mixed superheated) — the finale gun: thick chamber, nethersteel layers | a wall-breaking shot for the finale's last wave (finale doc; no mod in the pack fields a hostile vehicle, so the target is the wave, not a machine); nothing in the finale is gated on it |
...
the feedback asked for. G10's shot is the designed answer to the finale's fifth wave at the gate; nothing is gated on the gun —
...
- `gscraft-camp-spec.md`: `site.py` (templates per site and tier, keeper summons) beside `camp.py`; ~~the gun pit on the plateau's east bluff~~ the gun pit at the mast field's west edge, x −846…−835 × z −1000…−989 (2026-09-13, reconciliation), in the camp's tier-0 layout.
